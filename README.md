# Awesome ALX [![Track Awesome List](https://www.trackawesomelist.com/badge.svg)](https://www.trackawesomelist.com/utilitycoder/awesome-alx/)
...
- [Arrow functions](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Functions/Arrow_function)
...
- [Mypy: Optional Static Typing for Python — Mypy 0.812 documentation](https://mypy.readthedocs.io/en/stable/)
...
- [asyncio — Asynchronous I/O — Python 3.9.6 documentation](https://docs.python.org/3/library/asyncio.html)

### 0x02-Python-Async-Comprehension

- [PEP 530 -- Asynchronous Comprehensions | Python.org](https://www.python.org/dev/peps/pep-0530/)
